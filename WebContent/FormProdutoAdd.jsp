...
<%@ page import="sells.control.ProdutoControl" import="sells.dao.ProdutoDAO" %>
...
<%
	...
	<div class="container">
		<form id="contact" action="./ProdutoControl" method="post">
			<h3 id="FormProdutoPesq">Cadastrar Produto</h3>
			<h4>Adicione os dados do Produto.
			</h4>
			<fieldset>
			...
			<fieldset>
				<label>Data de Validade</label> <input type="text" name="txtValidade"
