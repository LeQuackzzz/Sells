...
<body>
	...
	<div class="container">
		<form id="contact" action="./FornecedorControl" method="post">
			<h3 id="FormFornecedorPesq">Cadastrar Fornecedor</h3>
			<h4>Adicione os dados do Fornecedor.
			</h4>
			<fieldset>
				<label>Nome</label> <input id="nome" type="text" name="txtNome" />
			</fieldset>
			<fieldset>
			...
			<fieldset>
				<label>Status (1-Ativo/ 2-Inativo)</label> <input type="text"
					name="txtStatus" maxlength="1" />
			</fieldset>
			<fieldset>
